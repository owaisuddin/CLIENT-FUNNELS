...
<head>
    ...
    <link href="{{ asset('images/icon/manifest.json') }}" rel="stylesheet">
    ...
    <link rel="stylesheet" href="https://www.clientfunnels.io/vendor/fontawesome/webfonts/fa-solid-900.ttf">
