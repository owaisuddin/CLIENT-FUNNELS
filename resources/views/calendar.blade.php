...
<!--/ Privacy Modal -->    <!-- View Booking modal -->
<div id="cal-booking-modal" class="modal hmodal-success" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="color-line"></div>
            <div class="modal-header">
                <h5 class="modal-title">View Contact Booked Call</h5>
            </div>
            ...
            <div class="modal-body">
                ...
                <small>
                    <strong><span class="cbd-contact-name"></span></strong> (ID: <span class="cbd-contact-id"></span>)
                </small>

                <hr>

                <h3 class="text-center">Call Booking</h3>
                <div class="row">
                    <div class="col-sm-4">
                        <strong>Booked Call ID:</strong>
                    </div>
                    <div class="col-sm-8 cbd-booking-booked_call_id"></div>
                </div>
                <hr class="cbd-booking-booked_call_id-hr">

                <div class="row">
                    <div class="col-sm-4">
                        <strong>Booked With:</strong>
                    </div>
                    <div class="col-sm-8 cbd-booking-booked_with"></div>
                </div>
                <hr class="cbd-booking-booked_with-hr">

                <div class="row">
                    <div class="col-sm-4">
                        <strong>Call Start:</strong>
                    </div>
                    <div class="col-sm-8 cbd-booking-call_start"></div>
                </div>
...
{{--                </div>--}}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 cbd-booking-call_duration"></div>
                </div>
                <hr class="cbd-booking-call_duration-hr">

                <div class="row">
                    <div class="col-sm-4">
                        <strong>Booked:</strong>
                    </div>
                    <div class="col-sm-8 cbd-booking-booked"></div>
                </div>
                <hr class="cbd-booking-booked-hr">

                <div class="row">
                    <div class="col-sm-4">
                        <strong>Call Status:</strong>
                    </div>
                    <div class="col-sm-8 cbd-booking-status"></div>
                </div>
