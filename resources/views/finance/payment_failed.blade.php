                                ...
                                <div class="col-md-12 ml-auto mr-auto">
                                    <div class="page-categories">
                                        ...
                                        <ul class="nav nav-pills nav-pills-rose nav-pills-icons justify-content-center"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="/payments/successful" role="tablist">
                                                    <i class="fa fa-check"></i> <span class="text-success">Successful  (0)</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="/payments/pending" role="tablist">
                                                    <i class="fas fa-sync-alt"></i> <span class="text-warning">Pending (0)</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link active" href="/payments/failed" role="tablist">
                                                    <i class="fas fa-times"></i> <span
                                                            class="text-danger">Failed (0)</span> </a>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="tab-content tab-space tab-subcategories">
                                            ...
                                            <h3 class="text-center">Failed Payments</h3>
                                            ...
                                            <div class="material-datatables">
                                                <div id="dt-list-payments-table_wrapper"
                                                     class="dataTables_wrapper dt-bootstrap4">
                                                    <div class="row">
                                                        <div class="col-sm-12 col-md-6">
                                                            <div class="dataTables_length"
                                                                 id="dt-list-payments-table_length"><label>Show <select
                                                                            name="dt-list-payments-table_length"
                                                                            aria-controls="dt-list-payments-table"
                                                        ...
                                                        <div class="col-sm-12 col-md-6">
                                                            <div id="dt-list-payments-table_filter"
                                                                 class="dataTables_filter"><label>Search:<input
                                                                            type="search"
                                                                            class="form-control form-control-sm"
                                                                            placeholder=""
                                                                            aria-controls="dt-list-payments-table"></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <table id="dt-list-payments-table" data-type="failed"
                                                                   class="table table-striped table-no-bordered table-hover dataTable dtr-inline"
                                                                   cellspacing="0" width="100%" style="width:100%"
                                                                   role="grid"
                                                                   aria-describedby="dt-list-payments-table_info">
                                                                <thead>
                                                                <tr role="row">
                                                                    <th class="sorting" tabindex="0"
                                                                        aria-controls="dt-list-payments-table"
                                                                        rowspan="1" colspan="1"
                                                                        aria-label="Contact Payment ID: activate to sort column ascending">
                                                                        Contact Payment ID
                                                                    </th>
                                                                    <th class="sorting" tabindex="0"
                                                                        aria-controls="dt-list-payments-table"
                                                                    ...
                                                                    <th class="sorting" tabindex="0"
                                                                        aria-controls="dt-list-payments-table"
                                                                        rowspan="1" colspan="1"
                                                                        aria-label="Card Used: activate to sort column ascending">
                                                                        Card Used
                                                                    </th>
                                                                    <th class="sorting" tabindex="0"
                                                                        aria-controls="dt-list-payments-table"
                                                                    ...
                                                                    <th class="sorting" tabindex="0"
                                                                        aria-controls="dt-list-payments-table"
                                                                        rowspan="1" colspan="1"
                                                                        aria-label="Payment Made: activate to sort column ascending">
                                                                        Payment Made
                                                                    </th>
                                                                ...
                                                                <tr class="odd">
                                                                    <td valign="top" colspan="8"
                                                                        class="dataTables_empty">No data available in
                                                                        table
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                                <tfoot>
                                                                <tr>
                                                                    <th rowspan="1" colspan="1">Contact Payment ID</th>
                                                                    <th rowspan="1" colspan="1">Contact</th>
                                                                    <th rowspan="1" colspan="1">Program</th>
                                                                    <th rowspan="1" colspan="1">Amount</th>
                                                                    <th rowspan="1" colspan="1">Card Used</th>
                                                                    <th rowspan="1" colspan="1">Description</th>
                                                                    <th rowspan="1" colspan="1">Payment Made</th>
                                                            ...
                                                            <div id="dt-list-payments-table_processing"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 col-md-5">
                                                            <div class="dataTables_info"
                                                                 id="dt-list-payments-table_info" role="status"
                                                                 aria-live="polite">Showing 0 to 0 of 0 entries
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12 col-md-7">
                                                            <div class="dataTables_paginate paging_simple_numbers"
                                                                 id="dt-list-payments-table_paginate">
                                                                <ul class="pagination">
                                                                    <li class="paginate_button page-item previous disabled"
                                                                        id="dt-list-payments-table_previous"><a href="#"
                                                                                                                aria-controls="dt-list-payments-table"
                                                                                                                data-dt-idx="0"
                                                                                                                tabindex="0"
                                                                    ...
                                                                    <li class="paginate_button page-item next disabled"
                                                                        id="dt-list-payments-table_next"><a href="#"
                                                                                                            aria-controls="dt-list-payments-table"
                                                                                                            data-dt-idx="1"
                                                                                                            tabindex="0"
