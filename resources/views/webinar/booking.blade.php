    ...
    <div class="container">
        <div class="row align-items-center">
          ...
          <span class="clr-wh pl-5 pt-3">
            <h1 id="preview-webinar-title">New Call Booking</h1>
          </span>
            </div>
        </div>
    </div>
...
<div class="container">
    ...
    <section class="form-section">
        <div class="container-fluid">
            ...
            <form method="post" action="{{url('booking_webinar/'.$campaign_id)}}">
                @csrf
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="new-booking-name" required name="name"
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="new-booking-email" class="bmd-label-floating"> Email<span
                                        class="required">*</span></label>
                            <input type="email" class="form-control" id="new-booking-email" required="true" name="email"
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="new-booking-mobile" name="mobile" maxlength="25"
                                   value="{{ old('mobile') }}">
                            @error('mobile')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                ...
                <div class="call-button pt- pb-5">
                    <div class="row justify-content-center align-items-center">
                        <div class="col-md-3">
                            <button type="input"
                                    class="btn btn-warning hvr-sweep-to-top wow flipInX save-new-booking animated"
                                    data-wow-delay="0.2s"
...
{{--<script src="https://www.clientfunnels.io/vendor/cs-webinar/jquery/app.js?v=1.3"></script>--}}
